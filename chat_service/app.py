...
import pandas as pd  # Added import for pd in rag_handler
...
PRODUCT_SERVICE = os.environ.get('PRODUCT_SERVICE_URL', 'http://product-service:8080')
ORDER_SERVICE = os.environ.get('ORDER_SERVICE_URL', 'http://order-service:8080')
...
def handle_chat():
    try:
        ...
        if 'message' not in data or not data['message'].strip():
            logger.info("Invalid query: Missing or empty message parameter")
